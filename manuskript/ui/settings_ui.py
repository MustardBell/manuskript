...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.revisionBackendLayout = QtWidgets.QFormLayout()
        self.revisionBackendLayout.setObjectName("revisionBackendLayout")
        self.lblRevisionBackend = QtWidgets.QLabel(self.page_3)
        self.lblRevisionBackend.setObjectName("lblRevisionBackend")
        self.revisionBackendLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.lblRevisionBackend)
        self.cmbRevisionBackend = QtWidgets.QComboBox(self.page_3)
        self.cmbRevisionBackend.setObjectName("cmbRevisionBackend")
        self.revisionBackendLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.cmbRevisionBackend)
        self.verticalLayout.addLayout(self.revisionBackendLayout)
        self.lblRevisionStatus = QtWidgets.QLabel(self.page_3)
        self.lblRevisionStatus.setText("")
        self.lblRevisionStatus.setWordWrap(True)
        self.lblRevisionStatus.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        self.lblRevisionStatus.setObjectName("lblRevisionStatus")
        self.verticalLayout.addWidget(self.lblRevisionStatus)
        self.btnInitGitRepository = QtWidgets.QPushButton(self.page_3)
        self.btnInitGitRepository.setObjectName("btnInitGitRepository")
        self.verticalLayout.addWidget(self.btnInitGitRepository)
        self.grpGitRevisionOptions = QtWidgets.QGroupBox(self.page_3)
        self.grpGitRevisionOptions.setObjectName("grpGitRevisionOptions")
        self.gitRevisionOptionsLayout = QtWidgets.QVBoxLayout(self.grpGitRevisionOptions)
        self.gitRevisionOptionsLayout.setObjectName("gitRevisionOptionsLayout")
        self.lblGitRevisionDescription = QtWidgets.QLabel(self.grpGitRevisionOptions)
        self.lblGitRevisionDescription.setWordWrap(True)
        self.lblGitRevisionDescription.setObjectName("lblGitRevisionDescription")
        self.gitRevisionOptionsLayout.addWidget(self.lblGitRevisionDescription)
        self.chkGitAutoCommit = QtWidgets.QCheckBox(self.grpGitRevisionOptions)
        self.chkGitAutoCommit.setObjectName("chkGitAutoCommit")
        self.gitRevisionOptionsLayout.addWidget(self.chkGitAutoCommit)
        self.chkGitTaggedOnly = QtWidgets.QCheckBox(self.grpGitRevisionOptions)
        self.chkGitTaggedOnly.setChecked(True)
        self.chkGitTaggedOnly.setObjectName("chkGitTaggedOnly")
        self.gitRevisionOptionsLayout.addWidget(self.chkGitTaggedOnly)
        self.btnManageGitRevisions = QtWidgets.QPushButton(self.grpGitRevisionOptions)
        self.btnManageGitRevisions.setObjectName("btnManageGitRevisions")
        self.gitRevisionOptionsLayout.addWidget(self.btnManageGitRevisions)
        self.verticalLayout.addWidget(self.grpGitRevisionOptions)
        ...
        self.cmbCorkStyle = QtWidgets.QComboBox(self.groupBox_11)
        font = QtGui.QFont()
        font.setBold(False)
        self.cmbCorkStyle.setFont(font)
        self.cmbCorkStyle.setObjectName("cmbCorkStyle")
        self.verticalLayout_19.addWidget(self.cmbCorkStyle)
        ...
        self.verticalLayout_style.addItem(spacerItem15)
...
" to words"))
        ...
        self.label_44.setText(_translate("Settings", "Revisions keep recoverable versions of your writing. Choose internal per-text snapshots or Git project history."))
        self.chkRevisionsKeep.setText(_translate("Settings", "Keep revisions"))
        self.lblRevisionBackend.setText(_translate("Settings", "Implementation:"))
        self.btnInitGitRepository.setText(_translate("Settings", "Create a Git repository here…"))
        self.grpGitRevisionOptions.setTitle(_translate("Settings", "Git revisions"))
        self.lblGitRevisionDescription.setText(_translate("Settings", "Use the existing Git repository as project history. Manuskript reads commits without checking them out. Tagged commits can serve as uncluttered author milestones."))
        self.chkGitAutoCommit.setText(_translate("Settings", "Commit automatically after Manuskript saves"))
        self.chkGitTaggedOnly.setText(_translate("Settings", "Show tagged milestones by default"))
        self.btnManageGitRevisions.setText(_translate("Settings", "Open Git revision history…"))
        ...
        self.cmbCorkStyle.setToolTip(_translate("Settings", "Index card styles provided by Manuskript and by plugins."))
